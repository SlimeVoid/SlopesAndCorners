package slimevoid.interiorcorners.client.render;
...
public class BlockInteriorCornersRenderer implements
	...
	public void renderInvBlock(RenderBlocks renderblocks, Block block, int i,
		...
		if (j == InteriorCornersConfig.IntCornersRenderID) {
			...
			renderIntCornersBottomFace(block, 0.0D, 0.0D, 0.0D,
					block.getBlockTextureFromSideAndMetadata(0, i), i + 1,
					renderblocks, 240);
			tessellator.draw();
			tessellator.startDrawingQuads();
			tessellator.setNormal(0.0F, 1.0F, 0.0F);
			renderIntCornersTopFace(block, 0.0D, 0.0D, 0.0D,
					block.getBlockTextureFromSideAndMetadata(1, i), i + 1,
					renderblocks, 240);
			tessellator.draw();
			tessellator.startDrawingQuads();
			tessellator.setNormal(0.0F, 0.0F, -1F);
			renderIntCornersEastFace(block, 0.0D, 0.0D, 0.0D,
					block.getBlockTextureFromSideAndMetadata(2, i), i + 1,
					renderblocks, 240);
			tessellator.draw();
			tessellator.startDrawingQuads();
			tessellator.setNormal(0.0F, 0.0F, 1.0F);
			renderIntCornersWestFace(block, 0.0D, 0.0D, 0.0D,
					block.getBlockTextureFromSideAndMetadata(3, i), i + 1,
					renderblocks, 240);
			tessellator.draw();
			tessellator.startDrawingQuads();
			tessellator.setNormal(-1F, 0.0F, 0.0F);
			renderIntCornersNorthFace(block, 0.0D, 0.0D, 0.0D,
					block.getBlockTextureFromSideAndMetadata(4, i), i + 1,
					renderblocks, 240);
			tessellator.draw();
			tessellator.startDrawingQuads();
			tessellator.setNormal(1.0F, 0.0F, 0.0F);
			renderIntCornersSouthFace(block, 0.0D, 0.0D, 0.0D,
					block.getBlockTextureFromSideAndMetadata(5, i), i + 1,
					renderblocks, 240);
			tessellator.draw();
			GL11.glTranslatef(0.5F, 0.5F, 0.5F);
		}
	...
	public boolean renderWorldBlock(RenderBlocks renderblocks,
		...
		if (l == InteriorCornersConfig.IntCornersRenderID) {
	...
	public boolean renderBlockIntCorners(Block block, int i, int j, int k,
		...
		if (Minecraft.isAmbientOcclusionEnabled()) {
			return renderIntCornersBlockWithAmbientOcclusion(block, i, j, k, f,
					f1, f2, iDir, renderblocks, iblockaccess);
		} else {
			return renderIntCornersBlockWithColorMultiplier(block, i, j, k, f,
					f1, f2, iDir, renderblocks, iblockaccess);
		}
	}

	public boolean renderIntCornersBlockWithAmbientOcclusion(Block block,
			int i, int j, int k, float f, float f1, float f2, int iDir,
			RenderBlocks renderblocks, IBlockAccess iblockaccess) {
		enableAO = true;
		boolean flag = false;
		boolean flag1 = true;
		...
		if (renderblocks.renderAllFaces
			...
			renderIntCornersBottomFace(block, i, j, k,
		...
		if (renderblocks.renderAllFaces
			...
			renderIntCornersTopFace(block, i, j, k,
					block.getBlockTexture(iblockaccess, i, j, k, 0), iDir,
					renderblocks,
					block.getMixedBrightnessForBlock(iblockaccess, i, j, k));
			flag = true;
		...
		if (renderblocks.renderAllFaces
			...
			renderIntCornersEastFace(block, i, j, k, l, iDir, renderblocks,
					block.getMixedBrightnessForBlock(iblockaccess, i, j, k));
			if (field_27511_cfgGrassFix && l == 3) {
				...
				renderIntCornersEastFace(block, i, j, k, 38, iDir,
						renderblocks,
						block.getMixedBrightnessForBlock(iblockaccess, i, j, k));
			}
			flag = true;
		...
		if (renderblocks.renderAllFaces
			...
			renderIntCornersWestFace(block, i, j, k, i1, iDir, renderblocks,
					block.getMixedBrightnessForBlock(iblockaccess, i, j, k));
			if (field_27511_cfgGrassFix && i1 == 3) {
				...
				renderIntCornersWestFace(block, i, j, k, 38, iDir,
						renderblocks,
						block.getMixedBrightnessForBlock(iblockaccess, i, j, k));
			}
			flag = true;
		...
		if (renderblocks.renderAllFaces
			...
			renderIntCornersNorthFace(block, i, j, k, j1, iDir, renderblocks,
					block.getMixedBrightnessForBlock(iblockaccess, i, j, k));
			if (field_27511_cfgGrassFix && j1 == 3) {
				...
				renderIntCornersNorthFace(block, i, j, k, 38, iDir,
						renderblocks,
						block.getMixedBrightnessForBlock(iblockaccess, i, j, k));
			}
			flag = true;
		...
		if (renderblocks.renderAllFaces
			...
			renderIntCornersSouthFace(block, i, j, k, k1, iDir, renderblocks,
					block.getMixedBrightnessForBlock(iblockaccess, i, j, k));
			if (field_27511_cfgGrassFix && k1 == 3) {
				...
				renderIntCornersSouthFace(block, i, j, k, 38, iDir,
						renderblocks,
						block.getMixedBrightnessForBlock(iblockaccess, i, j, k));
			}
			flag = true;
	...
	public boolean renderIntCornersBlockWithColorMultiplier(Block block, int i,
		...
		if (renderblocks.renderAllFaces
				|| block.shouldSideBeRendered(iblockaccess, i, j - 1, k, 0)
				|| iDir / 4 == 1 || iDir / 4 == 3) {
			float f20 = block.getAmbientOcclusionLightValue(iblockaccess, i,
					j - 1, k);
		...
		if (renderblocks.renderAllFaces
				|| block.shouldSideBeRendered(iblockaccess, i, j + 1, k, 1)
				|| iDir / 4 == 0 || iDir / 4 == 2) {
			float f21 = block.getAmbientOcclusionLightValue(iblockaccess, i,
					j + 1, k);
		...
		if (renderblocks.renderAllFaces
			...
			renderIntCornersEastFace(block, i, j, k,
		...
		if (renderblocks.renderAllFaces
			...
			renderIntCornersWestFace(block, i, j, k,
		...
		if (renderblocks.renderAllFaces
			...
			renderIntCornersNorthFace(block, i, j, k,
		...
		if (renderblocks.renderAllFaces
			...
			renderIntCornersSouthFace(block, i, j, k,
	...
	public void renderIntCornersBottomFace(Block block, double d, double d1,
	...
	public void renderIntCornersTopFace(Block block, double d, double d1,
			double d2, int i, int iDir, RenderBlocks renderblocks,
			int lBrightness) {
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(lBrightness);
	...
	public void renderIntCornersEastFace(Block block, double d, double d1,
			double d2, int i, int iDir, RenderBlocks renderblocks,
			int lBrightness) {
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(lBrightness);
			...
			if (iDir == 2 || iDir == 10) {
				...
				if (iDir == 0) {
					...
					tessellator.setColorOpaque_F(colorRedSlopes
							...
							* (factorTop + factorEast + factorNorth) / 3F,
							colorGreenSlopes * (aoLightValueYPosZNeg)
									* (factorTop + factorEast + factorNorth)
									/ 3F, colorBlueSlopes
									* (aoLightValueYPosZNeg)
									* (factorTop + factorEast + factorNorth)
									/ 3F);
					...
					tessellator.setColorOpaque_F(colorRedSlopes
							...
							* (factorTop + factorEast + factorNorth) / 3F,
							colorGreenSlopes * (aoLightValueXNegZNeg)
									* (factorTop + factorEast + factorNorth)
									/ 3F, colorBlueSlopes
									* (aoLightValueXNegZNeg)
									* (factorTop + factorEast + factorNorth)
									/ 3F);
					tessellator.addVertexWithUV(d8, d10, d12, (d3 + d4) / 2.0F,
							d6);
					tessellator.setColorOpaque_F(colorRedSlopes
							* (aoLightValueXNegYPos)
							* (factorTop + factorEast + factorNorth) / 3F,
							colorGreenSlopes * (aoLightValueXNegYPos)
									* (factorTop + factorEast + factorNorth)
									/ 3F, colorBlueSlopes
									* (aoLightValueXNegYPos)
									* (factorTop + factorEast + factorNorth)
				...
				if (iDir == 4) {
					...
					tessellator.setColorOpaque_F(colorRedSlopes
							...
							* (factorBottom + factorEast + factorNorth) / 3F,
							colorGreenSlopes * (aoLightValueXNegYNeg)
									* (factorBottom + factorEast + factorNorth)
									/ 3F, colorBlueSlopes
									* (aoLightValueXNegYNeg)
									* (factorBottom + factorEast + factorNorth)
									/ 3F);
					...
					tessellator.setColorOpaque_F(colorRedSlopes
							...
							* (factorBottom + factorEast + factorNorth) / 3F,
							colorGreenSlopes * (aoLightValueXNegZNeg)
									...
									* (factorBottom + factorEast + factorNorth)
									/ 3F);
					tessellator.addVertexWithUV(d8, d11, d12, (d3 + d4) / 2.0F,
							d5);
					tessellator.setColorOpaque_F(colorRedSlopes
							* (aoLightValueYNegZNeg)
							* (factorBottom + factorEast + factorNorth) / 3F,
							colorGreenSlopes * (aoLightValueYNegZNeg)
									* (factorBottom + factorEast + factorNorth)
									/ 3F, colorBlueSlopes
									* (aoLightValueYNegZNeg)
									* (factorBottom + factorEast + factorNorth)
	...
	public void renderIntCornersWestFace(Block block, double d, double d1,
			double d2, int i, int iDir, RenderBlocks renderblocks,
			int lBrightness) {
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(lBrightness);
				...
				if (iDir == 1) {
					...
					tessellator.setColorOpaque_F(colorRedSlopes
							...
							* (factorTop + factorWest + factorSouth) / 3F,
							colorGreenSlopes * (aoLightValueXPosZPos)
									* (factorTop + factorWest + factorSouth)
									/ 3F, colorBlueSlopes
									* (aoLightValueXPosZPos)
									* (factorTop + factorWest + factorSouth)
									/ 3F);
					tessellator.addVertexWithUV(d9, d10, d12, (d3 + d4) / 2.0F,
							d6);
					tessellator.setColorOpaque_F(colorRedSlopes
							* (aoLightValueXPosYPos)
							* (factorTop + factorWest + factorSouth) / 3F,
							colorGreenSlopes * (aoLightValueXPosYPos)
									* (factorTop + factorWest + factorSouth)
									/ 3F, colorBlueSlopes
									* (aoLightValueXPosYPos)
									* (factorTop + factorWest + factorSouth)
					...
					tessellator.setColorOpaque_F(colorRedSlopes
							...
							* (factorTop + factorWest + factorSouth) / 3F,
							colorGreenSlopes * (aoLightValueYPosZPos)
									* (factorTop + factorWest + factorSouth)
									/ 3F, colorBlueSlopes
									* (aoLightValueYPosZPos)
									* (factorTop + factorWest + factorSouth)
				...
				if (iDir == 5) {
					...
					tessellator.setColorOpaque_F(colorRedSlopes
							...
							* (factorBottom + factorWest + factorSouth) / 3F,
							colorGreenSlopes * (aoLightValueYNegZPos)
					...
					tessellator.setColorOpaque_F(colorRedSlopes
							...
							* (factorBottom + factorWest + factorSouth) / 3F,
							colorGreenSlopes * (aoLightValueXPosYNeg)
									* (factorBottom + factorWest + factorSouth)
									/ 3F, colorBlueSlopes
									* (aoLightValueXPosYNeg)
									* (factorBottom + factorWest + factorSouth)
					...
					tessellator.setColorOpaque_F(colorRedSlopes
							...
							* (factorBottom + factorWest + factorSouth) / 3F,
							colorGreenSlopes * (aoLightValueXPosZPos)
									...
									* (factorBottom + factorWest + factorSouth)
									/ 3F);
					tessellator.addVertexWithUV(d9, d11, d12, (d3 + d4) / 2.0F,
							d5);
				}
				if (iDir == 13) {
					// Slope Facing Down - West
	...
	public void renderIntCornersNorthFace(Block block, double d, double d1,
			double d2, int i, int iDir, RenderBlocks renderblocks,
			int lBrightness) {
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(lBrightness);
		...
		if (enableAO) {
			if (iDir == 3 || iDir == 11) {
				...
				if (iDir == 3) {
					...
					tessellator.setColorOpaque_F(colorRedSlopes
							* (aoLightValueYPosZPos)
							* (factorTop + factorNorth + factorWest) / 3F,
							colorGreenSlopes * (aoLightValueYPosZPos)
									* (factorTop + factorNorth + factorWest)
									/ 3F, colorBlueSlopes
									* (aoLightValueYPosZPos)
									* (factorTop + factorNorth + factorWest)
									/ 3F);
					...
					tessellator.setColorOpaque_F(colorRedSlopes
							...
							* (factorTop + factorNorth + factorWest) / 3F,
							colorGreenSlopes * (aoLightValueXNegZPos)
									* (factorTop + factorNorth + factorWest)
									/ 3F, colorBlueSlopes
									* (aoLightValueXNegZPos)
									* (factorTop + factorNorth + factorWest)
									/ 3F);
					tessellator.addVertexWithUV(d8, d9, d12, (d3 + d4) / 2.0F,
							d6);
				}
				if (iDir == 11) {
				...
				if (iDir == 7) {
					...
					tessellator.setColorOpaque_F(colorRedSlopes
							* (aoLightValueXNegZPos)
							* (factorBottom + factorNorth + factorWest) / 3F,
							colorGreenSlopes * (aoLightValueXNegZPos)
									* (factorBottom + factorNorth + factorWest)
									/ 3F, colorBlueSlopes
									* (aoLightValueXNegZPos)
									* (factorBottom + factorNorth + factorWest)
									/ 3F);
	...
	public void renderIntCornersSouthFace(Block block, double d, double d1,
			double d2, int i, int iDir, RenderBlocks renderblocks,
			int lBrightness) {
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(lBrightness);
				...
				if (iDir == 2) {
					...
					tessellator.setColorOpaque_F(colorRedSlopes
							...
							* (factorTop + factorSouth + factorEast) / 3F,
							colorGreenSlopes * (aoLightValueXPosYPos)
									* (factorTop + factorSouth + factorEast)
									/ 3F, colorBlueSlopes
									* (aoLightValueXPosYPos)
									* (factorTop + factorSouth + factorEast)
									/ 3F);
					...
					tessellator.setColorOpaque_F(colorRedSlopes
							...
							* (factorTop + factorSouth + factorEast) / 3F,
							colorGreenSlopes * (aoLightValueXPosZNeg)
									* (factorTop + factorSouth + factorEast)
									/ 3F, colorBlueSlopes
									* (aoLightValueXPosZNeg)
									* (factorTop + factorSouth + factorEast)
									/ 3F);
					tessellator.addVertexWithUV(d8, d9, d11, (d3 + d4) / 2.0F,
							d6);
					tessellator.setColorOpaque_F(colorRedSlopes
							* (aoLightValueYPosZNeg)
							* (factorTop + factorSouth + factorEast) / 3F,
					...
					tessellator.setColorOpaque_F(colorRedSlopes
							...
							* (factorBottom + factorSouth + factorEast) / 3F,
							colorGreenSlopes * (aoLightValueXPosZNeg)
									...
									* (factorBottom + factorSouth + factorEast)
									/ 3F);
					tessellator.addVertexWithUV(d8, d10, d11, (d3 + d4) / 2.0F,
							d5);
					tessellator.setColorOpaque_F(colorRedSlopes
							* (aoLightValueXPosZNeg)
							* (factorBottom + factorSouth + factorEast) / 3F,
