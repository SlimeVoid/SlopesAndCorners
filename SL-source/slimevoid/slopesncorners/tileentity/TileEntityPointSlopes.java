...
public class TileEntityPointSlopes extends TileEntitySlopesBase {
	...
	private void setSlopesBounds(BlockBase blockbase, int i, int iDir) {
		...
		case 0:
			...
			blockbase.setBlockBounds(.0625F * i, 0.0F, .0625F * i, 1.0f - (.0625F * i), .0625F * i, 1.0f - (.0625F * i));
			break;		
		case 1:
			blockbase.setBlockBounds(1.0F - (.0625F * i), (.0625F * i), 1.0F - (.0625F * i), (.0625F * i),
					1.0f, (.0625F * i));
			break;	
		}
	}
