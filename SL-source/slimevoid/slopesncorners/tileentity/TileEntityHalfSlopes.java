...
public class TileEntityHalfSlopes extends TileEntitySlopesBase {
	...
	private void setSlopesBounds(BlockBase blockbase, int i, int iDir) {
		...
		case 0:
		case 1:
			blockbase.setBlockBounds(.0625F * i, 0.0F, 0.0F, 1.0f - (.0625F * i), .0625F * i, 1.0F);
			break;		
		case 2:
		case 3:
			blockbase.setBlockBounds(0.0f, 0.0F, .0625F * i, 1.0f, .0625F * i, 1.0f - (.0625F * i));
			break;
		case 4:
		case 5:
			blockbase.setBlockBounds(1.0F - (.0625F * i), (.0625F * i), 0.0F, (.0625F * i),
					1.0f, 1.0F);
			break;
		case 6:
		case 7:
