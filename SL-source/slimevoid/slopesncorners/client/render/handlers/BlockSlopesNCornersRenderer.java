...
public class BlockSlopesNCornersRenderer implements ISimpleBlockRenderingHandler {
...
/*			if (((BlockSlopesNCorners)block).GetCorneriDir(world,x,y,z) > -1){
				...
				return renderBlockIntCorner(block, x, y, z, renderer,
						world,((BlockSlopesNCorners)block).GetIntCorneriDir(world,x,y,z));
			}else{
				return renderBlockSlopes(block, x, y, z, renderer,
						world);
			}*/
	...
	public boolean renderBlockCorner(Block block, int i, int j, int k, RenderBlocks renderblocks, IBlockAccess iblockaccess,int iDir)
	{
	...
	public boolean renderBlockIntCorner(Block block, int i, int j, int k, RenderBlocks renderblocks, IBlockAccess iblockaccess,int iDir)
	{
		int l = block.colorMultiplier(iblockaccess, i, j, k);
		float f = (l >> 16 & 0xff) / 255F;
		float f1 = (l >> 8 & 0xff) / 255F;
