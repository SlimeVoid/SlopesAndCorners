...
public class BlockOblicSlopesRenderer extends BlockSlopesRendererBase {
	...
	public boolean renderCustomBlockWithAmbientOcclusion(Block block, int i, int j, int k, float f, float f1, float f2, int iDir, int model, RenderBlocks renderblocks, IBlockAccess iblockaccess) {
		...
		if (block.getBlockTexture(iblockaccess, i, j, k, 0) == Block.dirt
	...
	public boolean renderCustomBlockBlockWithColorMultiplier(Block block, int i, int j, int k, float f, float f1, float f2, int iDir, int model, RenderBlocks renderblocks, IBlockAccess iblockaccess) {
		...
		if (renderblocks.renderAllFaces || block
				.shouldSideBeRendered(iblockaccess, i, j - 1, k, 0) || iDir / 4 == 1 || iDir / 4 == 3) {
		...
		if (renderblocks.renderAllFaces || block
				.shouldSideBeRendered(iblockaccess, i, j, k - 1, 2) || iDir % 2 == 0) {
		...
		if (renderblocks.renderAllFaces || block
				.shouldSideBeRendered(iblockaccess, i, j, k + 1, 3) || iDir % 2 == 1) {
		...
		if (renderblocks.renderAllFaces || block
				.shouldSideBeRendered(iblockaccess, i - 1, j, k, 4) || iDir == 0 || iDir == 3 || iDir == 4 || iDir == 7 || iDir == 11 || iDir == 15) {
		...
		if (renderblocks.renderAllFaces || block
				.shouldSideBeRendered(iblockaccess, i + 1, j, k, 5) || iDir == 1 || iDir == 2 || iDir == 5 || iDir == 6 || iDir == 10 || iDir == 14) {
	...
	public void renderIntCornersBottomFace(Block block, double d, double d1, double d2, Icon i, int iDir, RenderBlocks renderblocks, int lBrightness) {
		...
		if (enableAO) {
			if (iDir / 4 == 0) {
				...
				tessellator.addVertexWithUV(d7, d9, d10, d3, d5);
				tessellator
						.setColorOpaque_F(	colorRedTopRight_BottomFace,
											colorGreenBottomRight_BottomFace,
											colorBlueBottomRight_BottomFace);
				tessellator.addVertexWithUV(d8, d9, d11, d4, d6);
				tessellator.setColorOpaque_F(	colorRedTopRight_BottomFace,
		...
		if (enableAO) {
			if (iDir == 2) {
				...
				if (iDir == 0) {
					...
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueYPosZNeg) * (factorTop + factorEast + factorNorth) / 3F,
												colorGreenSlopes * (aoLightValueYPosZNeg) * (factorTop + factorEast + factorNorth) / 3F,
												colorBlueSlopes * (aoLightValueYPosZNeg) * (factorTop + factorEast + factorNorth) / 3F);
					tessellator.addVertexWithUV(d9, d11, d12, d3, d5);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueYPosZNeg) * (factorTop + factorEast + factorNorth) / 3F,
												colorGreenSlopes * (aoLightValueYPosZNeg) * (factorTop + factorEast + factorNorth) / 3F,
					...
					tessellator.addVertexWithUV(d9, d11, d12, d3, d5);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueXNegZNeg) * (factorTop + factorEast + factorNorth) / 3F,
												colorGreenSlopes * (aoLightValueXNegZNeg) * (factorTop + factorEast + factorNorth) / 3F,
												colorBlueSlopes * (aoLightValueXNegZNeg) * (factorTop + factorEast + factorNorth) / 3F);
					tessellator.addVertexWithUV(d8,
												...
												d6);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueXNegYPos) * (factorTop + factorEast + factorNorth) / 3F,
												colorGreenSlopes * (aoLightValueXNegYPos) * (factorTop + factorEast + factorNorth) / 3F,
												colorBlueSlopes * (aoLightValueXNegYPos) * (factorTop + factorEast + factorNorth) / 3F);
				...
				if (iDir == 4) {
					...
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueXNegYNeg) * (factorBottom + factorEast + factorNorth) / 3F,
												colorGreenSlopes * (aoLightValueXNegYNeg) * (factorBottom + factorEast + factorNorth) / 3F,
												colorBlueSlopes * (aoLightValueXNegYNeg) * (factorBottom + factorEast + factorNorth) / 3F);
					tessellator.addVertexWithUV(d8, d10, d13, d4, d6);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueXNegZNeg) * (factorBottom + factorEast + factorNorth) / 3F,
												colorGreenSlopes * (aoLightValueXNegZNeg) * (factorBottom + factorEast + factorNorth) / 3F,
												colorBlueSlopes * (aoLightValueXNegZNeg) * (factorBottom + factorEast + factorNorth) / 3F);
					tessellator.addVertexWithUV(d8,
												d11,
												d12,
												(d3 + d4) / 2.0F,
												d5);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueYNegZNeg) * (factorBottom + factorEast + factorNorth) / 3F,
												colorGreenSlopes * (aoLightValueYNegZNeg) * (factorBottom + factorEast + factorNorth) / 3F,
												colorBlueSlopes * (aoLightValueYNegZNeg) * (factorBottom + factorEast + factorNorth) / 3F);
					tessellator.addVertexWithUV(d9, d10, d12, d3, d6);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueYNegZNeg) * (factorBottom + factorEast + factorNorth) / 3F,
												colorGreenSlopes * (aoLightValueYNegZNeg) * (factorBottom + factorEast + factorNorth) / 3F,
		...
		if (enableAO) {
			if (iDir == 3) {
				...
				if (iDir == 1) {
					...
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueXPosZPos) * (factorTop + factorWest + factorSouth) / 3F,
												colorGreenSlopes * (aoLightValueXPosZPos) * (factorTop + factorWest + factorSouth) / 3F,
												colorBlueSlopes * (aoLightValueXPosZPos) * (factorTop + factorWest + factorSouth) / 3F);
					tessellator.addVertexWithUV(d9,
												...
												d6);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueXPosYPos) * (factorTop + factorWest + factorSouth) / 3F,
												colorGreenSlopes * (aoLightValueXPosYPos) * (factorTop + factorWest + factorSouth) / 3F,
												colorBlueSlopes * (aoLightValueXPosYPos) * (factorTop + factorWest + factorSouth) / 3F);
					tessellator.addVertexWithUV(d9, d11, d13, d4, d5);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueYPosZPos) * (factorTop + factorWest + factorSouth) / 3F,
												colorGreenSlopes * (aoLightValueYPosZPos) * (factorTop + factorWest + factorSouth) / 3F,
												colorBlueSlopes * (aoLightValueYPosZPos) * (factorTop + factorWest + factorSouth) / 3F);
					tessellator.addVertexWithUV(d8, d11, d12, d3, d5);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueYPosZPos) * (factorTop + factorWest + factorSouth) / 3F,
												colorGreenSlopes * (aoLightValueYPosZPos) * (factorTop + factorWest + factorSouth) / 3F,
				...
				if (iDir == 5) {
					...
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueYNegZPos) * (factorBottom + factorWest + factorSouth) / 3F,
												colorGreenSlopes * (aoLightValueYNegZPos) * (factorBottom + factorWest + factorSouth) / 3F,
												colorBlueSlopes * (aoLightValueYNegZPos) * (factorBottom + factorWest + factorSouth) / 3F);
					tessellator.addVertexWithUV(d8, d10, d12, d3, d6);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueXPosYNeg) * (factorBottom + factorWest + factorSouth) / 3F,
												colorGreenSlopes * (aoLightValueXPosYNeg) * (factorBottom + factorWest + factorSouth) / 3F,
												colorBlueSlopes * (aoLightValueXPosYNeg) * (factorBottom + factorWest + factorSouth) / 3F);
					tessellator.addVertexWithUV(d8, d10, d12, d3, d6);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueXPosZPos) * (factorBottom + factorWest + factorSouth) / 3F,
												colorGreenSlopes * (aoLightValueXPosZPos) * (factorBottom + factorWest + factorSouth) / 3F,
												colorBlueSlopes * (aoLightValueXPosZPos) * (factorBottom + factorWest + factorSouth) / 3F);
	...
	public void renderIntCornersNorthFace(Block block, double d, double d1, double d2, Icon i, int iDir, RenderBlocks renderblocks, int lBrightness) {
		...
		if (enableAO) {
			if (iDir == 3) {
				...
				tessellator
						.setColorOpaque_F(	colorRedBottomRight_NorthFace,
				...
				if (iDir == 3) {
					...
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueYPosZPos) * (factorTop + factorNorth + factorWest) / 3F,
												colorGreenSlopes * (aoLightValueYPosZPos) * (factorTop + factorNorth + factorWest) / 3F,
												colorBlueSlopes * (aoLightValueYPosZPos) * (factorTop + factorNorth + factorWest) / 3F);
					tessellator.addVertexWithUV(d13, d10, d12, d4, d5);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueXNegYPos) * (factorTop + factorNorth + factorWest) / 3F,
												colorGreenSlopes * (aoLightValueXNegYPos) * (factorTop + factorNorth + factorWest) / 3F,
												colorBlueSlopes * (aoLightValueXNegYPos) * (factorTop + factorNorth + factorWest) / 3F);
					tessellator.addVertexWithUV(d8, d10, d11, d3, d5);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueXNegYPos) * (factorTop + factorNorth + factorWest) / 3F,
												colorGreenSlopes * (aoLightValueXNegYPos) * (factorTop + factorNorth + factorWest) / 3F,
					...
					tessellator.addVertexWithUV(d8, d10, d11, d3, d5);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueXNegZPos) * (factorTop + factorNorth + factorWest) / 3F,
												colorGreenSlopes * (aoLightValueXNegZPos) * (factorTop + factorNorth + factorWest) / 3F,
												colorBlueSlopes * (aoLightValueXNegZPos) * (factorTop + factorNorth + factorWest) / 3F);
					tessellator.addVertexWithUV(d8,
												d9,
												d12,
												(d3 + d4) / 2.0F,
				...
				if (iDir == 7) {
					...
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueXNegZPos) * (factorBottom + factorNorth + factorWest) / 3F,
												colorGreenSlopes * (aoLightValueXNegZPos) * (factorBottom + factorNorth + factorWest) / 3F,
												colorBlueSlopes * (aoLightValueXNegZPos) * (factorBottom + factorNorth + factorWest) / 3F);
					tessellator.addVertexWithUV(d8,
												d10,
												d12,
												(d3 + d4) / 2.0F,
												d5);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueXNegYNeg) * (factorBottom + factorNorth + factorWest) / 3F,
												colorGreenSlopes * (aoLightValueXNegYNeg) * (factorBottom + factorNorth + factorWest) / 3F,
												colorBlueSlopes * (aoLightValueXNegYNeg) * (factorBottom + factorNorth + factorWest) / 3F);
					tessellator.addVertexWithUV(d8, d9, d11, d3, d6);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueXNegYNeg) * (factorBottom + factorNorth + factorWest) / 3F,
												colorGreenSlopes * (aoLightValueXNegYNeg) * (factorBottom + factorNorth + factorWest) / 3F,
					...
					tessellator.addVertexWithUV(d8, d9, d11, d3, d6);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueYNegZPos) * (factorBottom + factorNorth + factorWest) / 3F,
												colorGreenSlopes * (aoLightValueYNegZPos) * (factorBottom + factorNorth + factorWest) / 3F,
												colorBlueSlopes * (aoLightValueYNegZPos) * (factorBottom + factorNorth + factorWest) / 3F);
		...
		if (enableAO) {
			if (iDir == 2) {
				...
				if (iDir == 2) {
					...
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueXPosYPos) * (factorTop + factorSouth + factorEast) / 3F,
												colorGreenSlopes * (aoLightValueXPosYPos) * (factorTop + factorSouth + factorEast) / 3F,
												colorBlueSlopes * (aoLightValueXPosYPos) * (factorTop + factorSouth + factorEast) / 3F);
					tessellator.addVertexWithUV(d8, d10, d12, d3, d5);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueXPosZNeg) * (factorTop + factorSouth + factorEast) / 3F,
												colorGreenSlopes * (aoLightValueXPosZNeg) * (factorTop + factorSouth + factorEast) / 3F,
												colorBlueSlopes * (aoLightValueXPosZNeg) * (factorTop + factorSouth + factorEast) / 3F);
					tessellator.addVertexWithUV(d8,
												d9,
												d11,
												(d3 + d4) / 2.0F,
												d6);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueYPosZNeg) * (factorTop + factorSouth + factorEast) / 3F,
												colorGreenSlopes * (aoLightValueYPosZNeg) * (factorTop + factorSouth + factorEast) / 3F,
												colorBlueSlopes * (aoLightValueYPosZNeg) * (factorTop + factorSouth + factorEast) / 3F);
				...
				tessellator.addVertexWithUV(d8, d9, d11, d4, d6);
				tessellator
						.setColorOpaque_F(	colorRedBottomRight_SouthFace,
				...
				if (iDir == 6) {
					...
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueXPosYNeg) * (factorBottom + factorSouth + factorEast) / 3F,
												colorGreenSlopes * (aoLightValueXPosYNeg) * (factorBottom + factorSouth + factorEast) / 3F,
												colorBlueSlopes * (aoLightValueXPosYNeg) * (factorBottom + factorSouth + factorEast) / 3F);
					tessellator.addVertexWithUV(d8, d9, d12, d3, d6);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueYNegZNeg) * (factorBottom + factorSouth + factorEast) / 3F,
												colorGreenSlopes * (aoLightValueYNegZNeg) * (factorBottom + factorSouth + factorEast) / 3F,
												colorBlueSlopes * (aoLightValueYNegZNeg) * (factorBottom + factorSouth + factorEast) / 3F);
					tessellator.addVertexWithUV(d13, d9, d11, d4, d6);
					tessellator
							.setColorOpaque_F(	colorRedSlopes * (aoLightValueXPosZNeg) * (factorBottom + factorSouth + factorEast) / 3F,
												colorGreenSlopes * (aoLightValueXPosZNeg) * (factorBottom + factorSouth + factorEast) / 3F,
												colorBlueSlopes * (aoLightValueXPosZNeg) * (factorBottom + factorSouth + factorEast) / 3F);
					tessellator.addVertexWithUV(d8,
												d10,
												d11,
												(d3 + d4) / 2.0F,
