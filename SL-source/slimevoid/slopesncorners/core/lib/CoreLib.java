...
public class CoreLib {
	...
	public static final String	MOD_VERSION			= "2.0.2.3";
	...
	public static final String	COMMON_PROXY		= "slimevoid.slopesncorners.proxy.CommonProxy";
	public static final String	MOD_RESOURCES		= "slopesncorners";
}
