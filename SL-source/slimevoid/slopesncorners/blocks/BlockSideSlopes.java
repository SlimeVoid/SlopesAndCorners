...
public class BlockSideSlopes extends BlockVannilaBased {
	 ...
	 * SlopesNCornersConfig.BlockBlackWoolSideSlopes != null) { world.setBlock(
	 * i, j, k, SlopesNCornersConfig.BlockBlackWoolSideSlopes.blockID,
	 * lOldMeta,3); return true; } else if (itemstack.getItemDamage() == 1 &&
	 * SlopesNCornersConfig.BlockRedWoolSideSlopes != null) { world.setBlock(i,
	 * j, k, SlopesNCornersConfig.BlockRedWoolSideSlopes.blockID, lOldMeta,3);
	 * return true; } else if (itemstack.getItemDamage() == 2 &&
	 * SlopesNCornersConfig.BlockGreenWoolSideSlopes != null) { world.setBlock(
	 * i, j, k, SlopesNCornersConfig.BlockGreenWoolSideSlopes.blockID,
	 * lOldMeta,3); return true; } else if (itemstack.getItemDamage() == 3 &&
	 * SlopesNCornersConfig.BlockBrownWoolSideSlopes != null) { world.setBlock(
	 * i, j, k, SlopesNCornersConfig.BlockBrownWoolSideSlopes.blockID,
	 * lOldMeta,3); return true; } else if (itemstack.getItemDamage() == 4 &&
	 * SlopesNCornersConfig.BlockBlueWoolSideSlopes != null) { world.setBlock(
	 * i, j, k, SlopesNCornersConfig.BlockBlueWoolSideSlopes.blockID,
	 * lOldMeta,3); return true; } else if (itemstack.getItemDamage() == 5 &&
	 * SlopesNCornersConfig.BlockPurpleWoolSideSlopes != null) { world.setBlock(
	 * i, j, k, SlopesNCornersConfig.BlockPurpleWoolSideSlopes.blockID,
	 * lOldMeta,3); return true; } else if (itemstack.getItemDamage() == 6 &&
	 * SlopesNCornersConfig.BlockCyanWoolSideSlopes != null) { world.setBlock(
	 * i, j, k, SlopesNCornersConfig.BlockCyanWoolSideSlopes.blockID,
	 * lOldMeta,3); return true; } else if (itemstack.getItemDamage() == 7 &&
	 * SlopesNCornersConfig.BlockSilverWoolSideSlopes != null) { world.setBlock(
	 * i, j, k, SlopesNCornersConfig.BlockSilverWoolSideSlopes.blockID,
	 * lOldMeta,3); return true; } else if (itemstack.getItemDamage() == 8 &&
	 * SlopesNCornersConfig.BlockGrayWoolSideSlopes != null) { world.setBlock(
	 * i, j, k, SlopesNCornersConfig.BlockGrayWoolSideSlopes.blockID,
	 * lOldMeta,3); return true; } else if (itemstack.getItemDamage() == 9 &&
	 * SlopesNCornersConfig.BlockPinkWoolSideSlopes != null) { world.setBlock(
	 * i, j, k, SlopesNCornersConfig.BlockPinkWoolSideSlopes.blockID,
	 * lOldMeta,3); return true; } else if (itemstack.getItemDamage() == 10 &&
	 * SlopesNCornersConfig.BlockLimeWoolSideSlopes != null) { world.setBlock(
	 * i, j, k, SlopesNCornersConfig.BlockLimeWoolSideSlopes.blockID,
	 * lOldMeta,3); return true; } else if (itemstack.getItemDamage() == 11 &&
	 * SlopesNCornersConfig.BlockYellowWoolSideSlopes != null) { world.setBlock(
	 * i, j, k, SlopesNCornersConfig.BlockYellowWoolSideSlopes.blockID,
	 ...
	 * SlopesNCornersConfig.BlockLightBlueWoolSideSlopes.blockID, lOldMeta,3);
	 * return true; } else if (itemstack.getItemDamage() == 13 &&
	 * SlopesNCornersConfig.BlockMagentaWoolSideSlopes != null) {
	 * world.setBlock( i, j, k,
	 * SlopesNCornersConfig.BlockMagentaWoolSideSlopes.blockID, lOldMeta,3);
	 * return true; } else if (itemstack.getItemDamage() == 14 &&
	 * SlopesNCornersConfig.BlockOrangeWoolSideSlopes!= null) { world.setBlock(
	 * i, j, k, SlopesNCornersConfig.BlockOrangeWoolSideSlopes.blockID,
	 * lOldMeta,3); return true; } else if (itemstack.getItemDamage() == 15 &&
	 * SlopesNCornersConfig.BlockWhiteWoolSideSlopes!= null) { world.setBlock(
	 * i, j, k, SlopesNCornersConfig.BlockWhiteWoolSideSlopes.blockID,
