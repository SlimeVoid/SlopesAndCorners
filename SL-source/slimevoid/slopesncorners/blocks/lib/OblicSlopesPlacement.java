...
public class OblicSlopesPlacement implements ISlopePlacement {
	...
	public boolean placeSlopeAt(ItemStack itemstack, EntityPlayer entityplayer,
		...
		TileEntityOblicSlopes tileentity = (TileEntityOblicSlopes) BlockHelper.getTileEntity(world, x, y, z, ConfigurationLib.blockSlopes.getTileMapData(metadata));
		if (tileentity == null) {
			return false;
		}
