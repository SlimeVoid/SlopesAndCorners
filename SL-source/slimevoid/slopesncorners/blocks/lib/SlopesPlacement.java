...
public class SlopesPlacement implements ISlopePlacement {
	...
	public boolean onPlaceSlope(ItemStack itemstack, EntityPlayer entityplayer, World world, int x, int y, int z, int i) {
		...
		// TileEntitySlopes tileentity = (TileEntitySlopes)
		// BlockHelper.getTileEntity(world, x, y, z, TileEntitySlopes.class);
		// if (tileentity != null) {
		// tileentity.setSlopeIndex((short)
		// MaterialsLib.damageToMaterialValue(itemstack.getItemDamage() &
		// 0xfff));
