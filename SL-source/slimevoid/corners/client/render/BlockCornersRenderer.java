package slimevoid.corners.client.render;
...
public class BlockCornersRenderer implements ISimpleBlockRenderingHandler {
	...
	public void renderInvBlock(RenderBlocks renderblocks, Block block, int i,
		...
		if (j == CornersConfig.CornersRenderID) {
	...
	public boolean renderWorldBlock(RenderBlocks renderblocks,
		...
		if (l == CornersConfig.CornersRenderID) {
	...
	public boolean renderCornersBlockWithAmbientOcclusion(Block block, int i,
		...
		if (renderblocks.renderAllFaces
			...
			if (field_27511_cfgGrassFix && l == 3) {
				...
				renderCornersEastFace(block, i, j, k, 38, iDir, renderblocks,
						block.getMixedBrightnessForBlock(iblockaccess, i, j, k));
			}
			flag = true;
		}
		if (renderblocks.renderAllFaces
			...
			if (field_27511_cfgGrassFix && i1 == 3) {
				...
				renderCornersWestFace(block, i, j, k, 38, iDir, renderblocks,
						block.getMixedBrightnessForBlock(iblockaccess, i, j, k));
			}
			flag = true;
		}
		if (renderblocks.renderAllFaces
			...
			if (field_27511_cfgGrassFix && j1 == 3) {
				...
				renderCornersNorthFace(block, i, j, k, 38, iDir, renderblocks,
						block.getMixedBrightnessForBlock(iblockaccess, i, j, k));
			}
			flag = true;
		}
		if (renderblocks.renderAllFaces
			...
			if (field_27511_cfgGrassFix && k1 == 3) {
				...
				renderCornersSouthFace(block, i, j, k, 38, iDir, renderblocks,
						block.getMixedBrightnessForBlock(iblockaccess, i, j, k));
			}
			flag = true;
		}
